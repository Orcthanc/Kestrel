...
*/
	...
	plane1.addComponent<TransformComponent>( glm::vec3{ 0, 0, 0 }, glm::quat{ glm::vec3{ 0, 0, 0 }}, glm::vec3{ 1, 1, 1 });
	...
	plane2.addComponent<TransformComponent>( glm::vec3{ 0, 0, -run_distances[run_num] }, glm::quat{ glm::vec3{ 0, 0, 0 }}, glm::vec3{ 1, 1, 1 });
...
#else
	camera->move( 0, 0, 10 * run_distances[run_num] );
#endif
}
